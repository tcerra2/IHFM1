...
class MergedUI:
    def __init__(self):
        ...
        self.model_type = tk.StringVar(value='general')  # 'general' or 'face'
        ...
        ttk.Combobox(scrollable_frame, textvariable=self.model_type, values=['general', 'face'], state="readonly", width=20).pack(fill="x", padx=10)
